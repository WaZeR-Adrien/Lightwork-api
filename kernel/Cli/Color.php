...
class Color
{
    ...
    const FOREGROUND_BOLD_BLUE = "1;34";
    const FOREGROUND_GREEN = "0;32";
    const FOREGROUND_BOLD_GREEN = "1;32";
    const FOREGROUND_CYAN = "0;36";
    const FOREGROUND_BOLD_CYAN = "1;36";
    const FOREGROUND_RED = "0;31";
    const FOREGROUND_BOLD_RED = "1;31";
    const FOREGROUND_PURPLE = "0;35";
    const FOREGROUND_BOLD_PURPLE = "1;35";
